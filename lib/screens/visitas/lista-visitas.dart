...
class _ListaVisitasPageState extends State<ListaVisitasPage> {
  ...
  PaginationVisitasModel _planes =
      new PaginationVisitasModel(CantidadTotal: 0, Listado: []);
  ...
  void _clearSearchQuery() {
    ...
    setState(() {
      _searchQuery.clear();
      updateSearchQuery("Historial de Visitas");
    });
  }
  ...
  Widget _buildSearchField() {
    return new TextField(
      ...
      onSubmitted: (text) {
        ...
        service
            .traerVisitas(selectedDateDesde, selectedDateHasta, filtro: text)
            .then((value) => {
                  setState(() {
                    index = 0;
                    total = value.CantidadTotal;
                          ...
                          child: Row(
                            children: <Widget>[
                              ...
                              Flexible(
                                child: Padding(
                                  child: Text(
                                      "${new DateFormat('dd/MM/yyyy').format(_planes.Listado[i].Visita_fecha.toLocal())}"),
                          ...
                          child: Row(
                            children: <Widget>[
                              ...
                              Flexible(
                                child: Padding(
                                  child:
                                      Text("${_planes.Listado[i].Direccion}"),
                                  padding: EdgeInsets.only(left: 10),
                                ),
                              )
                            ],
                          ...
                          child: Row(
                            children: <Widget>[
                              ...
                              Padding(
                                ...
                                child: Text("${_planes.Listado[i].Cliente}"),
                              )
                            ],
                          ),
                        ),
                          ...
                          child: Row(
                            children: <Widget>[
                              ...
                              Padding(
                                padding: EdgeInsets.fromLTRB(10, 0, 0, 0),
                                child: Text(
                                    "${_planes.Listado[i].Visita_Hora_Entrada}"),
                              )
                            ],
                          ),
                        ),
                        Container(
                          ...
                          child: Row(
                            children: <Widget>[
                              ...
                              Padding(
                                padding: EdgeInsets.fromLTRB(10, 0, 0, 0),
                                child: _planes.Listado[i].Visita_Hora_Salida ==
                                        null
                                    ? Text("-")
                                    : Text(
                                        "${_planes.Listado[i].Visita_Hora_Salida}"),
                              )
                            ],
                          ),
                        )
