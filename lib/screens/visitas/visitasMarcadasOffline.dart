...
class VisitasMarcadasOfflinePage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _VisitasMarcadasOfflinePageState();
  }
}

class _VisitasMarcadasOfflinePageState extends State<VisitasMarcadasOfflinePage>
                      ...
                      onTap: () {
                        if (!_visitas[index]
                          ...
                          var plan = new VisitaUpsertModel(
                              ...
                              Cliente_Cod: _visitas[index].Cliente_Cod,
                            ...
                            children: <Widget>[
                              Container(
                                ...
                                child: Row(
                                  ...
                                  children: <Widget>[
                                    Text(
                                        "${new DateFormat('dd/MM/yyyy').format(_visitas[index].Visita_fecha)}",
                                        style: TextStyle(fontSize: 20)),
                                    Text(
                                        "${new DateFormat('HH:mm').format(_visitas[index].Visita_Hora_Entrada)}",
                                        style: TextStyle(fontSize: 20))
                                  ],
                                ),
                              ),
